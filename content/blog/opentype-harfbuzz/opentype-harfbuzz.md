...
### Editing the input characters list

Double-clicking a character in the list pops up a character/glyph selection dialog, where you can choose a charcter of glyph to replace the selected character.

You can remove a selected character from the list by hitting the delete key.

Additionally you can right-click (or control-click) on a row in the character list, which will show a contextual menu with these items:
- Replace this character
- Insert character before this character
- Insert character after this character

Each will pop up a character/glyph selection dialog.
